...
export class TemplateService {
  ...
  /* CONTACT INFO TABLE */
  contactTypes: ContactType[] = [{ 'contactType': 'Name', 'icon': 'person', 'value': 'Raghavendra Bhatt' },
  { 'contactType': 'Address', 'icon': 'map', 'value': '7632 Halsey St,Apt 204 Lenexa KS 66216' }, { 'contactType': 'Phone', 'icon': 'phone', 'value': '+19134060640' }, { 'contactType': 'Email', 'icon': 'email', 'value': 'raghavendra.pes@gmail.com' }];
  ...
  /* TIME LINE DATA */
  timeLineDataSet: TimeLineData[] = [{ 'title': 'First Employment Details', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'isEdit': false, 'isDelete': false, 'showActions': false }, { 'title': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'This is the testing of teh time line module', 'isEdit': false, 'isDelete': false, 'showActions': false }, { 'title': 'Third Employment Details', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'isEdit': false, 'isDelete': false, 'showActions': false }];
  /* SKILL CHART DATA */
  ...
  getTimeLineData(): TimeLineData[] {
    let imeLineDataSet: TimeLineData[] = [{ 'title': 'First Employment Details', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'isEdit': false, 'isDelete': false, 'showActions': false }, { 'title': 'Second Employment Details', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'isEdit': false, 'isDelete': false, 'showActions': false }, { 'title': 'Third Employment Details', 'startTime': '2016-Nov-15', 'endTime': '2016-Nov-15', 'desc': 'Add your employment description by doubleclicking on the content. To edit complete information use the edit icon.', 'isEdit': false, 'isDelete': false, 'showActions': false }];
  ...
  getDescContent(): ProfileDescription {
    let content: ProfileDescription = { description: "A resume's objective is typically your statement of goals.Please add your objective which suits for the job you are applying. ( Double click on this section to add your objective )" }
    return content;
  }
  getContactTypes(): ContactType[] {
    let contactTypes: ContactType[] = [{ 'contactType': 'Name', 'icon': 'person', 'value': 'Your Name' },
    { 'contactType': 'Address', 'icon': 'map', 'value': 'Your Address' }, { 'contactType': 'Phone', 'icon': 'phone', 'value': '+1-111-111111' }, { 'contactType': 'Email', 'icon': 'email', 'value': 'youremail@email.com' }];
    return contactTypes;
  }
  ...
  getAvailableSections(): Section[] {
    let sections: Section[] = [
      ...
      {
        name: 'Technical Skills/Abilities',
        component: [{
          name: 'Progress complete',
          type: ComponentType.SKILL_PROGRESS
        },
  ...
  let CARD_DETAILS2: CardConfig = { title: 'Professional Experience', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '345', index: '1', isEnlarge: false, type: ComponentType.TIMELINE_STEPPER, cardPlacing: 'left' };
  let CARD_DETAILS3: CardConfig = { title: 'Skills', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '456', index: '2', isEnlarge: false, type: ComponentType.SKILL_PROGRESS, cardPlacing: 'right' };
  let CARD_DETAILS4: CardConfig = { title: 'Education', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '567', index: '3', isEnlarge: false, type: ComponentType.SIMPLE_TIMELINE, cardPlacing: 'left' };
  let CARD_DETAILS5: CardConfig = { title: 'Certificates & Recognization', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '789', index: '4', isEnlarge: false, type: ComponentType.SKILL_CHIPS, cardPlacing: 'right' };
  ...
  let CARD_DETAILS_T2_3: CardConfig = { title: 'Technical Skills/Softwares', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '3', index: '2', isEnlarge: false, icon: 'ion-medkit', type: ComponentType.SKILL_CHART, cardPlacing: 'right' };
  ...
  let CARD_DETAILS_T3_2: CardConfig = { title: 'Professional Experience', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '345', index: '1', isEnlarge: false, type: ComponentType.TIMELINE_STEPPER, cardPlacing: 'right' };
  let CARD_DETAILS_T3_3: CardConfig = { title: 'Skills', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '456', index: '2', isEnlarge: false, type: ComponentType.SKILL_PROGRESS, cardPlacing: 'left' };
  let CARD_DETAILS_T3_4: CardConfig = { title: 'Education', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '567', index: '3', isEnlarge: false, type: ComponentType.SIMPLE_TIMELINE, cardPlacing: 'right' };
  let CARD_DETAILS_T3_5: CardConfig = { title: 'Certificates & Recognization', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '789', index: '4', isEnlarge: false, type: ComponentType.SKILL_CHIPS, cardPlacing: 'right' };
  ...
  let CARD_DETAILS_T4_2: CardConfig = { title: 'Professional Experience', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '345', index: '1', isEnlarge: false, type: ComponentType.TIMELINE_STEPPER, cardPlacing: 'left' };
  let CARD_DETAILS_T4_3: CardConfig = { title: 'Skills', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '456', index: '2', isEnlarge: false, type: ComponentType.SKILL_PROGRESS, cardPlacing: 'right' };
  let CARD_DETAILS_T4_4: CardConfig = { title: 'Education', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '567', index: '3', isEnlarge: false, type: ComponentType.SIMPLE_TIMELINE, cardPlacing: 'left' };
  let CARD_DETAILS_T4_5: CardConfig = { title: 'Certificates & Recognization', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '789', index: '4', isEnlarge: false, type: ComponentType.SKILL_CHIPS, cardPlacing: 'right' };
  ...
  let CARD_DETAILS_T5_2: CardConfig = { title: 'Professional Experience', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '345', index: '1', isEnlarge: false, type: ComponentType.TIMELINE_STEPPER, cardPlacing: 'left' };
  let CARD_DETAILS_T5_3: CardConfig = { title: 'Skills', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '456', index: '2', isEnlarge: false, type: ComponentType.SKILL_PROGRESS, cardPlacing: 'right' };
  let CARD_DETAILS_T5_4: CardConfig = { title: 'Education', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '567', index: '3', isEnlarge: false, type: ComponentType.SIMPLE_TIMELINE, cardPlacing: 'left' };
  let CARD_DETAILS_T5_5: CardConfig = { title: 'Certificates & Recognization', cardClass: 'col-md-6', isCardNavigationEnabled: true, isDraggable: true, isDroppable: true, cardId: '789', index: '4', isEnlarge: false, type: ComponentType.SKILL_CHIPS, cardPlacing: 'right' };

  /* CARD MAPPING FROM ID TO TEMPLATE */
  let cardsList_T5: any = [CARD_DETAILS_T5_1, CARD_DETAILS_T5_2, CARD_DETAILS_T5_3, CARD_DETAILS_T5_4, CARD_DETAILS_T5_5];
  /* CARD MAPPING FROM ID TO TEMPLATE */
  this.cardToTemplateMaping = { 'template1': cardsList1, 'template2': cardsList_T2, 'template3': cardsList_T3, 'template4': cardsList_T4, 'template5': cardsList_T5 };
