...
export class Template6Component extends BaseTemplateComponent {
  ...
  ngOnInit() {
    ...
    super.ngOnInit();
    if(!this.cardsList){
      this.cardsList = this.service.getCardsListByTemplate('template6');
      this.pageSettings.colorTheme='#455A64';
      this.pageSettings.fontColor='#fff';
      this.pageSettings.cssClass='Blue-Grey-700';
