...
@Component({
    ...
    templateUrl: 'linear-timeline.component.html',
    styleUrls: ['linear-timeline.component.scss']
})
export class LinearTimelineComponent extends BaseTimelineComponent {
