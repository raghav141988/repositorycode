...
export class SideNavContentComponent {
    ...
    addSection(section:Section,component:ComponentType){
        if(component===undefined){
            component=section.component[0].type;
        }
        let event={
            'section':section,
